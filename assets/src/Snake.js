...
cc.Class({
    properties: (n = {
        ...
        _MapWidth: 0,
        _MapHeight: 0
    }, r(n, "_BodyTypeList", []), r(n, "_KillCount", 0), r(n, "_PosUpdateTime", 0), r(n, "_HeadPrePositon", cc.v2(1, 0)), r(n, "_CurAIType", 1), r(n, "_CurAITimer", 2), r(n, "_CurAIMoveCount", 0), r(n, "_CurTargetDestDir", cc.v2(1, 0)), r(n, "_CurTargetChangeDir", cc.v2(0, 0)), r(n, "_CurAITurnSpeed", 3.14), r(n, "_State", 0), r(n, "_StateTimer", 3), r(n, "_AttachLabel", null), r(n, "_CurShowMoveDistance", 0), r(n, "_CurShowMoveStartPos", cc.v2(0, 0)), r(n, "_ShowMovePosList", []), r(n, "_CurMoveIndex", 0), r(n, "_MovePath", []), r(n, "_BodySpace", 30), r(n, "_GodSprite", null), n),
    init: function(e, t, i, n, r, s, c, f, h) {
        ...
        var d = this._SnakeHead.getComponent(o);
        ...
        for (var u = 0; u < 5; ++u) {
            ...
            if (l) {
                ...
                var p = l.getComponent(a);
                p.setSnake(this), p.setBodyIndex(u), l.zIndex = -u, r && (l.group = "body");
                var b = Math.floor(u / 3) % 2;
                p.setType(t[b]), this._BodyWidth = l.width
            }
        }
        h < 10 && (this._GodSprite = GameGlobal.Game.GetFreeGodSprite(), this._GodSprite.parent = i, this._GodSprite.active = !1, this._GodSprite.group = "food")
    },
    ...
    getSnakeLength: function() {
        var e = this._HeadBodyList.length;
        return 5 * e + (e - 5) * (e - 5) * 5
    },
    deadFood: function(e) {
    ...
    setState: function(e) {
        this._State = e, 1 == e ? (this._StateTimer = 3, this.updateGodSpritePos()) : this._GodSprite.active = !1
    },
    deadReset: function() {
    ...
    initMoveDir: function(e) {
        ...
        for (var t, i = this._HeadBodyList.length, n = 0; n < i; ++n) {
            ...
            if (t.getComponent(a).setInitMoveDir(e), 0 == n);
            else;
        }
    ...
    setMoveSpeed: function(e) {
        ...
        if (t != this._MoveSpeed) {
            ...
            for (var i = this._HeadBodyList.length, n = 0; n < i; ++n) this._HeadBodyList[n].getComponent(a).setMoveSpeed(t)
        }
    },
