...
var n = require('Snake'),
    r = require('Food'),
    a = require('GameJoystick'),
    o = require('UIType'),
    s = require('SoundType'),
    c = [cc.v2(-120, -120), cc.v2(600, 600), cc.v2(-500, -800), cc.v2(200, 800), cc.v2(-800, 1200), cc.v2(500, -800), cc.v2(-300, 500), cc.v2(500, -400), cc.v2(-200, 400)],
    f = 2,
    h = 3,
    d = 4,
    u = cc.Class({
    ...
    l = cc.Class({
        ...
        onEnable: function() {
            ...
            this._SoundMgr = GameGlobal.SoundManager, this._SoundMgr.stopAll(), this._SoundMgr.playSound(s.SoundType_GameBg), this.KillSprite.node.active = false, cc.director.getCollisionManager().enabled = true, this._KillShowTimer = 0, this._CurTime = 120, 0 == this._DataMgr._CurSelectMode ? (this.TimerLabel.node.active = true, this.TimerSprite.active = true) : (this.TimerLabel.node.active = false, this.TimerSprite.active = false), this._NameList = [], GameGlobal.getRandomNameList(9, this._NameList), this._BodyList = [], this._HeadList = [];
            for (var e = 0; e < 10; ++e)
                if (0 == e) {
                    var t = new n,
        ...
        addFood: function() {
            ...
            i.parent = this.FoodBaseNode, i.x = e, i.y = t, i.zIndex = -500, i.group = "food", i.getComponent(r).setType(Math.floor(5 * Math.random()) + 1)
        },
        ...
        resetGameEnd: function() {
            ...
            for (e = 0; e < 10; ++e)
                if (0 == e) {
                    ...
                    (t = new n).init(this._HeadList[e - 1], this._BodyList[e - 1], this.AllObjNode, c[e - 1], this.Camera, false, this._MapSizeWidth, this._MapSizeHeight, e);
                    var a = cc.v2(1, 0);
        ...
        setGameState: function(e) {
            if (this._GameState != e)
                ...
                var i = this;
                GameGlobal.WeiXinPlatform.postScoreToPlatform(this._DataMgr.getCurScore(), this._DataMgr._GameStartTime), GameGlobal.Net.requestScore(t.getSnakeLength()), GameGlobal.UIManager.openUI(o.UIType_GameOver)
            } else if (this._GameState == d) {
                t = this._SnakeList[0];
                this._DataMgr.CurScore = t.getSnakeLength();
                i = this;
                GameGlobal.WeiXinPlatform.postScoreToPlatform(i._DataMgr.getCurScore(), this._DataMgr._GameStartTime), GameGlobal.Net.requestScore(t.getSnakeLength()), GameGlobal.UIManager.openUI(o.UIType_GameEnd), GameGlobal.Net.requestScoreGold(t.getSnakeLength())
            }
        },
